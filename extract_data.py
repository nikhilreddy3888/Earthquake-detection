...
def extract_data():
    ...
    filename = "/home/mila/y/yuyan.chen/Earthquake-detection/data/Instance_events_gm_10k.hdf5"
...
def visualize():
    var_name = "events_gm"
    filename = f"/home/mila/y/yuyan.chen/Earthquake-detection/extracted_data/{var_name}.npy"
